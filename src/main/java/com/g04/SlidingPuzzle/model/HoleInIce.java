 ...
 * Anything that slides into a HoleInIce falls into it. Naturally, HoleInIce
 * cannot
 * move or slide. If a penguin falls into a HoleInIce, that penguin is removed
 * from
 * the game. However, any food items collected are still counted at the end of
 * the game.
 * If a LightIceBlock or a SeaLion slides into a HoleInIce, those sliding
 * objects fall
 * to the hole and plug it. When a HoleInIce is plugged, any sliding objects can
 * pass
