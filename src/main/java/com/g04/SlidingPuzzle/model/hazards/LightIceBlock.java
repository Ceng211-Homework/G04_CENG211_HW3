 ...
 * hazards stop on the square they were at the moment of collision.
 * A sliding LightIceBlock can fall from the edges.
 * The colliding penguin is temporarily stunned and their
...
public class LightIceBlock extends Hazard {
    ...
    public CollisionResult handleCollision(ITerrainObject collidingObject) {
        if (collidingObject instanceof Penguin penguin) {
